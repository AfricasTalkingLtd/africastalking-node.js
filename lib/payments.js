...
Payments.prototype.bankCheckout = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        const rq = unirest.post(Common.MOBILE_PAYMENT_URL + '/bank/checkout/charge');
...
Payments.prototype.validateBankCheckout = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        const rq = unirest.post(Common.MOBILE_PAYMENT_URL + '/bank/checkout/validate');
...
Payments.prototype.bankTransfer = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        const rq = unirest.post(Common.MOBILE_PAYMENT_URL + '/bank/transfer');
...
Payments.prototype.cardCheckout = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        const { username, apiKey, format } = _self.options;
        const { productName, checkoutToken, paymentCard,
        currencyCode, amount, narration, metadata } = options;
        ...
        const rq = unirest.post(Common.MOBILE_PAYMENT_URL + '/card/checkout/charge');
...
Payments.prototype.validateCardCheckout = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        const rq = unirest.post(Common.MOBILE_PAYMENT_URL + '/card/checkout/validate');
