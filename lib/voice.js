...
Voice.prototype.Enqueue = function (params) {
    let options = _.cloneDeep(params);
    let _self = this;
    let validationError;
    ...
    if (holdMusic) action.attributes.holdMusic = holdMusic;
    if (name) action.attributes.name           = name;

    return this.buildAction(action);
}

Voice.prototype.Dequeue = function (params) {
    let options = _.cloneDeep(params);
    let _self = this;
    let validationError;
...
Voice.prototype.Redirect = function (params) {
    let options = _.cloneDeep(params);
    let _self = this;
    let validationError;
...
Voice.prototype.Conference = function () {
    let _self = this;
