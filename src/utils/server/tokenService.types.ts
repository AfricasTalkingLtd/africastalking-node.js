...
export type GetToken = (
  cxt: any,
  cb: (err: Error | null, response: GetTokenResponse | null) => void
) => Promise<void>;
...
export type GetSipCredentials = (
  _cxt: any,
  cb: (err: Error | null, response: { credentials: SipCredential[] }) => void
) => void;

export type AddSipCredentials = (
