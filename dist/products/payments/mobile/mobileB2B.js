...
var getSchema = function () { return joi_1.default.object({
    ...
    provider: joi_1.default.string().valid('Mpesa', 'TigoTanzania', 'Athena').required(),
    transferType: joi_1.default.string().valid('BusinessBuyGoods', 'BusinessPayBill', 'DisburseFundsToBusiness', 'BusinessToBusinessTransfer').required(),
