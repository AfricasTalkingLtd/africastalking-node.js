...
var getSchema = function () { return joi_1.default.object({
    ...
    recipients: joi_1.default.array().items(joi_1.default.object({
        ...
        reason: joi_1.default.string().valid('SalaryPayment', 'SalaryPaymentWithWithdrawalChargePaid', 'BusinessPayment', 'BusinessPaymentWithWithdrawalChargePaid', 'PromotionPayment').required(),
